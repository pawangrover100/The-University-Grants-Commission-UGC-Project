...
function AboutSection() {
  return (
    <>
      <ul>
        <li className="max-w-full mt-5 h-35 ">
          <a href="#">
            <img
              src={AboutImage}
        ...
        <li className="max-w-full mt-10  h-40 text-left">
          <a href="#" className="block max-w-295 mx-auto px-4">
        ...
        <li className="...">
          <div className="block max-w-295 mx-auto px-4">
            <AboutSectionButton />
            <SectionCards />
          </div>
        </li>
